...
This document explains the 24 downstream patches we currently carry on top of `rules_py` commit `a20bbd5c2b098a09656b458c7476d2c5478b9f80`.
...
- the 24 rebased commits we carry in `~/rules_py`
